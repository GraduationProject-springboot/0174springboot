...
|3|tushu\_name|String|图书标题|是|
|4|tushu\_types|Integer|图书类型|是|
|5|tushu\_photo|String|图书封面|是|
|6|tushu\_zuozhe|String|图书作者|是|
|7|chubanshe\_types|Integer|图书出版社|是|
|8|shujia\_types|Integer|所在书架|是|
|9|tushu\_number|Integer|图书数量|是|
|10|tushu\_content|String|图书详情|是|
...
|4|tushujieyue\_shijian|Integer|借阅时间|是|
|5|tushujieyue\_types|Integer|借阅状态|是|
|6|insert\_time|Date|借阅时间|是|
